...
/// Function that generated by [`BlockingOperator::ob_multipart_writer_with`].
///
/// Users can add more options by public functions provided by this struct.
pub struct FunctionObMultipartWriter(
    /// The args for FunctionWriter is a bit special because we also
    /// need to move the bytes input this function.
    pub(crate) OperatorFunction<(OpWrite, OpWriter), BlockingObMultipartWriter>,
);
...
impl FunctionObMultipartWriter {
    ...
    /// Call the function to consume all the input and generate a
    /// result.
    pub fn call(self) -> Result<BlockingObMultipartWriter> {
        self.0.call()
    }
}
...
/// Function that generated by [`BlockingOperator::put_object_tagging_with`].
///
/// Users can add more options by public functions provided by this struct.
pub struct FunctionPutObjTag(pub(crate) OperatorFunction<OpPutObjTag, ()>);

impl FunctionPutObjTag {
    /// Set the Tag for this operation.
    pub fn tag_set(mut self, tag_set: HashMap<String, String>) -> Self {
        self.0 = self.0.map_args(|args| args.with_tag_set(tag_set));
        self
    }
...
/// Function that generated by [`BlockingOperator::get_object_tagging`].
///
/// Users can add more options by public functions provided by this struct.
pub struct FunctionGetObjTag(pub(crate) OperatorFunction<(), HashMap<String, String>>);

impl FunctionGetObjTag {

    /// Call the function to consume all the input and generate a
    /// result
    pub fn call(self) -> Result<HashMap<String, String>> {
        self.0.call()
    }
}
