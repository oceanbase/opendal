...
/// Future that generated by [`Operator::put_object_tagging_with`].
///
/// Users can add more options by public functions provided by this struct.
pub type FuturePutObjTag<F> = OperatorFuture<OpPutObjTag, (), F>;

impl<F: Future<Output = Result<()>>> FuturePutObjTag<F> {
    /// Set the tag set for this operation.
    pub fn tag_set(self, tag_set: HashMap<String, String>) -> Self {
        self.map(|args| args.with_tag_set(tag_set))
    }
}

/// Future that generated by [`Operator::get_object_tagging_with`]
/// 
/// Users can add more options by public functions provided by this struct.
pub type FutureGetObjTag<F> = OperatorFuture<(), HashMap<String, String>, F>;

impl<F: Future<Output = Result<HashMap<String, String>>>> FutureGetObjTag<F> {
...
/// Future that generated by [`Operator::ob_multipart_writer_with`].
///
/// Users can add more options by public functions provided by this struct.
